...
namespace Battle_City
{
    class Player : BaseObject
    {
        ...
        public Player(Field _field) : base(_x, _y, PlayerFigure)
        {
        ...
        public void DrawToBuffer(char[,] buffer)
        {
            ...
            {
                buffer[bufferX, bufferY] = PlayerFigure[0];
                if (PlayerFigure.Length > 1 && bufferX < buffer.GetLength(0))
                    buffer[bufferX, bufferY] = PlayerFigure[1];
            }
        }

        public override void Display() { Console.Write(PlayerFigure); }
